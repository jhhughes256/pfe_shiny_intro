...
# In this step the scope of the application is expanded to cover patient data
#   from other admission diagnoses. Therefore the code responsible for 
#   subsetting the data will need to be moved to the server. Instead of 
#   attempting to make changes to the UI and server at the same time, the UI 
#   goes through another prototyping stage before adding in the new server code.
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
